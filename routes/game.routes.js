...
import { msgChatGpt, getConversation, generateCase, getCaseById, listCases, listUsers, sendStatus } from "../controllers/game.controllers.js"
...
gameRouter.post('/listUsers',listUsers)
